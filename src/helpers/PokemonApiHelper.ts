import { PokemonHelper } from '@/types';

export class PokemonApiHelper implements PokemonHelper {
  ...
  get specialAttack(): number {
    const hpStats = this.findStatsByName('special-attack');
    return hpStats ? Number(hpStats.base_stat) : 0;
  }
